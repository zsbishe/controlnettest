path_sd15 = 'epoch=999-step=999.ckpt'
path_sd15_with_control = './models/control_sd15_normal.pth'
path_input = './models/anything-v4.5-pruned.safetensors'
path_output = './models/control_any4.5_normal.pth'
