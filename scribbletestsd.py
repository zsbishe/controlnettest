...
model.load_state_dict(load_state_dict('./models/v1-5-pruned.ckpt', location='cuda'))
model = model.cuda()
...
# 设置参数
prompt = "A beautiful and green turtle"  # 替换为你的提示
...
#for i, image in enumerate(generated_images):
    ...
    # 定义保存图像的文件夹路径
output_folder = 'generated_images_scribbleuser_2_sd'
