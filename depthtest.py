...
model.load_state_dict(load_state_dict('./models/control_any4.5_depth.pth', location='cuda'))
model = model.cuda()
...
# 设置参数
prompt ='cyber robot speech'# "robot lecture"  # 替换为你的提示
...
#for i, image in enumerate(generated_images):
    ...
    # 定义保存图像的文件夹路径
output_folder = 'a-depth-sd-cyberrobotspeech-3'
