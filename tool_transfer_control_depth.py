path_sd15 ='epoch=999-step=999.ckpt'# './models/v1-5-pruned.ckpt'
path_sd15_with_control = './models/control_sd15_depth.pth'
path_input = './models/anything-v4.5-pruned.safetensors'#./models/anything-v3-full.safetensors'
path_output = './models/control_any4.5_depth.pth'
