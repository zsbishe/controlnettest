...
model.load_state_dict(load_state_dict('./models/control_any4.5_normal.pth', location='cuda'))
model = model.cuda()
...
# 设置参数
prompt ='Plaster statue of man'#'cute and white toy' #'Plaster statue of Abraham Lincoln'#'cute and white toy'#"cute and white toy like a cloud"  # 替换为你的提示
...
#for i, image in enumerate(generated_images):
    ...
    # 定义保存图像的文件夹路径
output_folder = 'a-normal-old-Plasterstatueofman-3'
