...
# 设置参数
prompt ='cute robot'# "oil painting of handsome old man, masterpiece"  # 替换为你的提示
...
#for i, image in enumerate(generated_images):
    ...
    # 定义保存图像的文件夹路径
output_folder = 'a-hed-sd-cuterobot-real-3'#'a-hed-cyber-cyberpunkrobot-real-3'#'a-old-oilpaintingofhandsomeoldmanmasterpiece-real-1'
