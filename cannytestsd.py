...
# 读取输入图片
input_image_path = 'test_imgs/bag.png'#'test_imgs/dog.png'  # 替换为你的图片路径
input_image = cv2.imread(input_image_path)

# 设置参数
prompt ='beautiful bag'#'a blue and white dog'# "A white  dog"  # 替换为你的提示
...
#for i, image in enumerate(generated_images):
    ...
    # 定义保存图像的文件夹路径
output_folder ='a-canny-bag-beautifulbag-sd-1' #'generated_images_cannydogsd_2'
