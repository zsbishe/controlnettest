...
model.load_state_dict(load_state_dict('./models/control_any4.5_canny.pth', location='cuda'))
model = model.cuda()
...
# 读取输入图片png
input_image_path ='test_imgs/dog2.png'#'test_imgs/bird.png'# 'test_imgs/dog.png'  # 替换为你的图片路径
input_image = cv2.imread(input_image_path)

# 设置参数
prompt ='cute dog'#a white cat'#'a colorful bird'# "A white  dog"  # 替换为你的提示
...
#for i, image in enumerate(generated_images):
    ...
    # 定义保存图像的文件夹路径
output_folder = 'a-canny-dog2-cutedog-2'
