...
model.load_state_dict(load_state_dict('./models/control_any_canny.pth', location='cuda'))
model = model.cuda()
...
# 读取输入图片
input_image_path = 'test_imgs/bird.png'  # 替换为你的图片路径
input_image = cv2.imread(input_image_path)

# 设置参数
prompt = "A beautiful and colorful bird"  # 替换为你的提示
...
#for i, image in enumerate(generated_images):
    ...
    # 定义保存图像的文件夹路径
output_folder = 'generated_images_cannybird_1_test'
